              ...
              <form action="php/evaluate_studentPHP.php?student_id=<?=$student_id?>" method="POST">
                <div class="section-container card">
                    ...
                    <div class="col-md">
                      <table class="table-cite">
                        ...
                        <tr>
                          ...
                          <td><input type="number" class="grade_input" name="grade[]" max="99" maxlength="2" value="<?php echo $row_subjects['grade'];?>"></td>
                        </tr>
                        <?php
                            }
                          }
                  ...
                  <div class="d-flex gap-2 mt-4 justify-content-end">
                    <button class="editbtn" type="submit" name="upd_eval_studentBtn">Submit Evaluation</button>
                  </div>
                </div>
              </form>
              <?php
