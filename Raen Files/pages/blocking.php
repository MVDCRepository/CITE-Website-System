                            ...
                            <ul class="navbar-nav md-auto">
                                ...
                                <li id="nav-last" class="nav-item last"><a class="nav-link dropdown-toggle" href="#"
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="navbarDropdown"
                                        ...
                                        <a style="font-weight: 600;" class="dropdown-item" href="#">Blocking</a>
                        ...
                        <div class="col-md-12">
                            <div class="block_result">
                                <table class="table table-bordered table-striped table-hover table-sm">
                                    ...
                                    <tr>
                                        <td>C100</td>
                                        <td>Web Development (Lec)</td>
                                        <td>Monday 09:00am - 11:00am <br> Thursday 09:00am - 11:00am</td>
                                    </tr>
                                    <tr>
                                        <td>C101</td>
                                        <td>Web Development (Lab)</td>
                                        <td>Tuesday 08:00am - 11:00am</td>
                                    </tr>
                                    <tr>
                                        <td>C102</td>
                                        <td>Literature</td>
                                        <td>Wednesday 01:00pm - 03:00pm</td>
                                    </tr>
                                </table>
                                <br>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-check">
                                                    <input
                                                        oninvalid="this.setCustomValidity('Please check the box to confirm your selected Block')"
                                                        oninput="this.setCustomValidity('')" type="checkbox"
                                                        class="form-check-input" id="confirm" required>
                                                    <label class="form-check-label" for="confirm">Check the box for the
                                                        confirmation</label>
                                                </div>
                                                <input type="submit" name="sub" value="Reserve Block"
