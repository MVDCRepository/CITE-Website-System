                    ...
                    <nav class="navbar navbar-expand-lg">
                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            <ul class="navbar-nav md-auto">
                                ...
                                <li class="nav-item">
                                    <a style="font-weight: 600;" class="nav-link" href="#">NEWS & EVENTS</a>
                                </li>
                                <li class="nav-item">
    ...
    <div class="service_main">
        <div class="container">
            <div class="title_events">
                <h1 class="title_events_text">UCU Events</h1>
            </div>
            <div class="row">
                <div class="col-sm-12">
                    <div class="events-section">
                        <li class="item-a">
                            <div class="events-card-box">
                                <img src="https://ucu.edu.ph/application/files/8916/5266/4406/drrmo-pubmat.png" alt="">
                                <h1 class="events-card-title">Identifying explosive hazards and threats training for UCU
                                    Personnel</h1>
                                <hr>
                                <p class="events-card-description"> The institution is continuously striving towards the
                                    cultivation of changes towards a much safer. </p>
                                <p class="events-card-date">May 18-19, 2022</p>
                            </div>
                        </li>
                        <li class="item-b">
                            <div class="events-card-box">
                                <img src="https://ucu.edu.ph/application/files/1216/4732/2205/deer.png" alt="">
                                <h1 class="events-card-title">UCU celebrates its 56th Foundation Anniversary
                                    highlighting its role as a deer</h1>
                                <hr>
                                <p class="events-card-description"> This symbolizes the 56th Foundation Anniversary
                                    theme, “Cultivating Change.” </p>
                                <p class="events-card-date">March 29-31, 2022</p>
                            </div>
                        </li>
                        <li class="item-c">
                            <div class="events-card-box">
                                <img src="https://ucu.edu.ph/application/files/1716/4733/5928/resbak1.jpg" alt="">
                                <h1 class="events-card-title">UCU hosts Resbakuna</h1>
                                <hr>
                                <p class="events-card-description"> The City Health Office and City Government of
                                    Urdaneta assisted the University to pursue 100% vaccination status among students,
                                    employees, and other members of the academic community. </p>
                                <p class="events-card-date">March 11, 2022</p>
                            </div>
                        </li>
                        <li class="item-d">
                            <div class="events-card-box">
                                <img src="https://ucu.edu.ph/application/files/2716/4663/3772/workshop1.jpg" alt="">
                                <h1 class="events-card-title">University officials undergo strategic planning workshop
                                </h1>
                                <hr>
                                <p class="events-card-description"> TDirectors, deans, and heads of different
                                    departments focused on the creation of their five-year development plan </p>
                                <p class="events-card-date">March 3, 2022</p>
                            </div>
                        </li>
                        <li class="item-e">
                            <div class="events-card-box">
                                <img src="https://ucu.edu.ph/application/files/2016/4584/2338/ormon1.jpg" alt="">
                                <h1 class="events-card-title">Orata’s monument unveiled; UCU honors founder’s legacy
                                </h1>
                                <hr>
                                <p class="events-card-description"> Urdaneta City University administration unveiled the
                                    newly-constructed Dr. Pedro T. Orata Monument. </p>
                                <p class="events-card-date">February 18, 2022</p>
                            </div>
                        </li>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="title_news" id="news">
                <h1 class="title_news_text">UCU News</h1>
            </div>
            <div class="row">
                <div class="col-md-12">
                    <div class="container-card-news-events">
                        <div class="card-content">
                            ...
                            <div class="card">
                                ...
                                <div class="card-info">
                                    <h3>UCU News Update</h3>
                                    <p>May 6, 2022, 4:19 PM</p>
                                </div>
                            </div>
                            <div class="card">
                                <div class="card-image">
                                    <img src="https://ucu.edu.ph/application/files/9916/5225/6275/thmb_cbm.jpg">
                                </div>
                                <div class="card-info">
                                    <h3>CamSur college visits ...</h3>
                                    <p>Apr 28, 2022, 3:59 PM</p>
                                </div>
                            </div>
                            <div class="card">
                                <div class="card-image">
                                    <img src="https://ucu.edu.ph/application/files/5516/4982/6225/thmb_56.PNG">
                                </div>
                                <div class="card-info">
                                    <h3>UCU’s 56th Foundation ...</h3>
                                    <p>Apr 12, 2022, 3:52 PM</p>
                                </div>
                            </div>
                            <div class="card">
                                <div class="card-image">
                                    <img src="https://ucu.edu.ph/application/files/1316/5086/5945/thmb-midw.jpg">
                                </div>
                                <div class="card-info">
                                    <h3>UCU produces new midwives</h3>
                                    <p>Apr 12, 2022, 1:48 PM</p>
                                </div>
                            </div>
                            <div class="card">
                                <div class="card-image">
                                    <img src="https://ucu.edu.ph/application/files/6716/5086/5585/thmb-pharma.jpg">
                                </div>
                                <div class="card-info">
                                    <h3>New UCU licensed ...</h3>
                                    <p>Apr 8, 2022, 1:33 PM</p>
                                </div>
                            </div>
                            <div class="card">
                                <div class="card-image">
        ...
        function showPage(whichPage) {
            ...
            getPageList(totalPages, currentPage, paginationSize).forEach(item => {
                $("<li>").addClass("page-item").addClass(item ? "current-page" : "dots").toggleClass(
                    "active", item == currentPage).append($("<a>").addClass("page-link")
                    .attr({
