                    ...
                    <nav class="navbar navbar-expand-lg">
                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            <ul class="navbar-nav md-auto">
                                ...
                                <li class="nav-item">
                                    <a style="font-weight: 600;" class="nav-link" href="#">FACULTY</a>
                                </li>
                                <li class="nav-item">
                            ...
                            <ul>
                                <li>
                                    <div class="timeline-content">
                                        <h3 class="date">College Dean</h3>
                                        <h1 data-aos="fade-right" data-aos-duration="2000">Johanns B. Rabago, LPT, MIT
                                        </h1>
                                        <img data-aos="fade-left" data-aos-duration="1000"
                                            src="../images/faculty_members/sir_johanns.png">
                                        <p>Subjects:</p>
                                    </div>
                                </li>
                                <li>
                                    <div class="timeline-content">
                                        ...
                                        <img data-aos="fade-left" data-aos-duration="1000" data-aos="fade-up"
                                            src="../images/faculty_members/sir_dionnel.png">
                                        <p>Subjects:</p>
                                    </div>
                                </li>
                            </ul>
