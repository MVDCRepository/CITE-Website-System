                    ...
                    <form>
                        <div class="reg_content">
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-6">
                                    <input type="text" class="form-control" id="graduated_shs"
                                        placeholder="Graduated Senior High School" required>
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    <input type="text" class="form-control" id="learners_ref_num"
                                        placeholder="Learners Reference Number" required>
                                </div>
                                <div class="form-group col-md-6">
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    <input type="text" class="form-control" id="form_138" placeholder="Form 138 GWA"
                                        required>
                                </div>
                                <div class="form-group col-md-6">
