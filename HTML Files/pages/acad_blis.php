...
<body>
                    ...
                    <nav class="navbar navbar-expand-lg">
                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            <ul class="navbar-nav md-auto">
                                ...
                                <li class="nav-item">
                                    <a style="font-weight: 600;" class="nav-link dropdown-toggle" href="#"
                                        id="navbarDropdown" role="button" data-toggle="dropdown">ACADEMICS</a>
                                    <div class="dropdown-menu" aria-labelledby="navbarDropdown"
                                        style="right: auto; left: auto;">
                                        <a class="dropdown-item" href="#">BSIT</a>
                                        <div class="dropdown-divider"></div>
                                        <a style="font-weight: 600;" class="dropdown-item" href="#">BLIS</a>
                                    </div>
                                </li>
                                <li class="nav-item">
    ...
    <div class="banner_news_events">
        <div class="titlepage-h1-news_events">
            <h1 class="bnner_title_news_events"><span>Academics</span> / Bachelor in Library & Information Science
            </h1>
        </div>
    </div>
    <!--End Banner Section -------------------------------->
