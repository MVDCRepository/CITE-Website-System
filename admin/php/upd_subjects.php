        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              ...
              <!-- form -->
              <form action="php/evaluationPHP.php?subj_id=<?=$subj_id?>" method="POST" id="upd_sub_form">
                <?php
                  include "db_conn.php";
                  $sql = "SELECT * FROM subject_tbl WHERE subj_id = $subj_id";
                  $result = $conn->query($sql);
                    if($result->num_rows > 0) {
                      while ($row=$result->fetch_assoc()) {
                ?>
                <div class="p-4 card mb-4">
                  <h5 class="mb-4">Update Subject</h5>
                  <center>
                  ...
                  <div class="row">
                    <div class="col-md-6 mb-3">
                      <input type="hidden" class="form-control" name="upd_subj_id" value="<?php echo $subj_id;?>">
                      <label class="form-label">Course Code</label>
                      <input type="text" class="form-control" name="upd_courseCode" value="<?php echo $row['courseCode'];?>" required>
                    </div>
                    <div class="col-md-6 mb-3">
                      <label class="form-label">Course Description</label>
                      <input type="text" class="form-control" name="upd_courseDesc" value="<?php echo $row['courseDesc'];?>" required>
                    </div>
                    <div class="col-md-6 mb-3">
                      <label class="form-label">Units</label>
                      <select class="select2 form-select" name="upd_units" required>
                    ...
                    <div class="col-md-6 mb-3">
                      ...
                      <select class="select2 form-select" name="upd_sem" required>
                    ...
                    <div class="col-md-6 mb-3">
                      ...
                      <select class="select2 form-select" name="upd_lec" required>
                        <option value="<?php echo $row['lec'];?>"><?php echo $row['lec'];?></option>
                        <option value="9">9</option>
                        <option value="8">8</option>
                        <option value="7">7</option>
                        <option value="6">6</option>
                    ...
                    <div class="col-md-6 mb-3">
                      ...
                      <select class="select2 form-select" name="upd_lab" required>
                        <option value="N/A"><?php echo $row['lab'];?></option>
                        <option value="9">9</option>
                        <option value="8">8</option>
                        <option value="7">7</option>
                        <option value="6">6</option>
                    ...
                    <div class="col-md-6 mb-3">
                      ...
                      <select class="select2 form-select" name="upd_yr_lvl" required>
                        <option value="<?php echo $row['yr_lvl'];?>"><?php echo $row['yr_lvl']." Year";?></option>
                        <option value="1st">1st Year</option>
                        <option value="2nd">2nd Year</option>
                        <option value="3rd">3rd Year</option>
                        <option value="3rd Middle term">3rd Year - Middle Term</option>
                        <option value="4th">4th Year</option>
                      </select>
                    </div>
                    <div class="col-md-6 mb-3">
                      <label class="form-label">Pre-requisites</label>
                      <input type="text" class="form-control" name="upd_pre_requisites" value="<?php echo $row['pre_requisites'];?>" required>
                    </div>
                    <div class="d-grid gap-2 d-md-block mt-3">
                      <button class="main-button" type="submit" name="upd_subBtn">Update Subject</button>
                    </div>
                  </div>
                </div>
                <?php
                    ...
                    echo "<center><span style='color: red'>Subject unavailable</span></center>";
                  }
                ?>
              </form>
              <!-- / form -->
