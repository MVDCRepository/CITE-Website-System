        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              ...
              <!-- page title -->
              <h4 class="fw-bold py-3"><span class="text-muted fw-light">News and Events /</span> Add</h4>
              <div class="section-container card">
                <!-- form -->
                <form action="php/add_news_eventsPHP.php" method="POST" id="news_eventsForm" enctype="multipart/form-data">
                  <?php if (isset($_GET['error'])) { ?>
                      <p class="error_msg" style="margin: 0px 0px 10px 0px"><?php echo $_GET['error']; ?></p>
                  <?php } ?>

                  <div class="image-container">
                    <img src="assets/ic_gallery.png" class="img-fluid" id="profileDisplay">
                  </div>
                  <div class="control-form">
                    <label>Photo</label>
                    <input type="file" class="ip-file" name="photo" id="photo" onChange="displayImage(this)" accept="image/png, image/jpeg" required>
                    <small>error message</small>
                  </div>
                  <br>
                  <div class="control-form">
                    <label>Title</label>
                    <input type="text" class="ip-text" name="title" id="title" required>
                    <small>error message</small>
                  </div>
                  <br>
                  <div class="control-form">
                  ...
                  <br>
                  <button class="main-button" name="uploadbtn">Upload</button>
                </form>
                <!-- /form -->
              </div>
            </div>
