            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              ...
              <form action="php/evaluationPHP.php?eval_id=<?=$eval_id?>" method="POST" id="upd_evaluation_form">
                ...
                <div class="p-4 card mb-4">
                  <h5 class="mb-4">Edit CMO & Series</h5>
                  <center>
                  ...
                  <div class="row">
                    <div class="col-md-6 mb-3">
                      ...
                      <input type="hidden" class="form-control" name="upd_eval_id" value="<?php echo $row['eval_id'];?>">
                      <input type="text" class="form-control" name="upd_cmoNo" value="<?php echo $row['cmoNo'];?>">
                    </div>
                    <div class="col-md-6 mb-3">
                      <label class="form-label">Series</label>
                      <input type="text" class="form-control" name="upd_series" value="<?php echo $row['series'];?>">
                    </div>
                    <div class="d-grid gap-2 d-md-block mt-3">
                      <button class="main-button" type="submit" name="upd_evalBtn">Save</button>
                    </div>
                  </div>
                </div>
                <?php
