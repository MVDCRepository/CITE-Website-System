        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              ...
              <!-- page title -->
              <h4 class="fw-bold py-3"><span class="text-muted fw-light">Announcements /</span> Add</h4>
              <div class="section-container card">
                <!-- form -->
                <form action="php/announcementsPHP.php" method="POST" id="announcements_form" enctype="multipart/form-data">
