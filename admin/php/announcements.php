...
>
  ...
  <body>
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              ...
              <div class="d-flex flex-wrap">
                <div class="p-2 flex-fill">
                  <!-- page title -->
                  <h4 class="fw-bold p-2"><span class="text-muted fw-light">Announcements /</span> Manage announcement</h4>
                </div>
                <div class="p-2 flex-fill">
                  <!-- search -->
                  <?php 
                    include "db_conn.php";
                    $sql = "SELECT * FROM announcement_tbl ORDER BY bulletin_id DESC";

                    if (isset($_POST['search'])) {
                      $search = $_POST['search'];
                      $sql = "SELECT * FROM announcement_tbl WHERE title LIKE '%$search%'";
                    }
                    else {
                      $search = "";
                        $sql = "SELECT * FROM announcement_tbl ORDER BY bulletin_id DESC";
              ...
              <div class="section-container card">
                ...
                <div class="table-wrapper">
                  <table class="table-cite" id="announcement_tbl">
                    <thead>
                      <tr>
                    ...
                    <tbody>
                     <?php
                      ...
                      <div class="delete-modal" id="modal_delete">
                        <div class="modalBox row">
                          ...
                          <div class="modal_body">
                            <form action="php/announcementsPHP.php" method="POST">
                      ...
                      <?php
                          ...
                          echo "<tr><td colspan='4' style='color: #ff0000;'><center>Announcement not found</center></td></tr>";
                        }
                        else {
    ...
    <!-- my js -->
    <script type="text/javascript" src="js/announcementsJS.js"></script>
  </body>
</html>
<?php
} else {
