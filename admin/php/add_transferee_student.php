          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              ...
              <ul class="nav nav-pills flex-column flex-sm-row mb-3">
                ...
                <li class="nav-item">
                  <a class="nav-link active" href="javascript:void(0);">Transferee</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" href="upload_student_csv.php">Upload CSV</a>
                </li>
              </ul>
              <!-- section container -->
              <center>
              ...
              <form action="php/studentPHP.php" method="POST">
                ...
                <div class="section-container card mt-4">
                  ...
                  <div class="d-grid gap-2 d-md-block mt-4">
                    <button class="main-button" type="submit" name="add_student_transfereeBtn">Add Student</button>
                  </div>
                </div>
              </form>
              <!-- / section container -->
