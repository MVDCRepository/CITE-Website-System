        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              ...
              <!-- page title -->
              <h4 class="fw-bold py-3"><span class="text-muted fw-light">News and Events /</span> Update</h4>
              <div class="section-container card">
                <!-- form -->
                <form action="php/add_news_eventsPHP.php?bulletin_id=<?=$bulletin_id?>" method="POST" id="news_eventsForm" enctype="multipart/form-data">
