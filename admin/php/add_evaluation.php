        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <!-- page title -->
              <h4 class="fw-bold p-2"><span class="text-muted fw-light">Evaluation /</span> Add</h4>
              <!-- form -->
              <form action="php/evaluationPHP.php" method="POST" id="add_evaluation_form">
                <div class="p-4 card mb-4">
                  <h5 class="mb-4">Create New CMO & Series</h5>
                  <center>
                    <?php if (isset($_GET['error'])) { ?>
                      <p class="error_msg mt-3 mb-3" style="margin: 0px 0px 10px 0px"><?php echo $_GET['error']; ?></p>
                    <?php } ?>
