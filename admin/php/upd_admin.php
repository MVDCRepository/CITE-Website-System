        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <!-- page title -->
              <h4 class="fw-bold p-2"><span class="text-muted fw-light">Account Settings /</span> Update Personal Information</h4>
              ...
              <!-- fetch information -->
              <form action="php/adminPHP.php" enctype="multipart/form-data" method="POST">
                <?php
                  include "db_conn.php";
                ...
                <div class="p-4 card mb-4">
                  ...
                  <input type="hidden" name="admin_id" id="admin_id" value="<?php echo $_SESSION['id'];?>">
                  <center>
                    <?php if (isset($_GET['error'])) { ?>
                      <p class="error_msg mb-5"><?php echo $_GET['error']; ?></p>
                    <?php } ?>
                    <?php if (isset($_GET['success_upd'])) { ?>
                      <p class="success_msg mb-5"><?php echo $_GET['success_upd']; ?></p>
                    <?php } ?>
                  </center>
                  ...
                  <div class="row">
                    ...
                    <div class="d-grid gap-2 d-sm-block mt-4">
                      <button class="main-button" type="submit" name="upd_info">Save Changes</button>
                    </div>
                  </div>
                </div>
                <?php
