        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <!-- page title -->
              <h4 class="fw-bold p-2"><span class="text-muted fw-light">Faculties /</span> Add Member</h4>
              <!-- form -->
              <form action="php/facultyPHP.php" enctype="multipart/form-data" method="POST" id="add_faculty_form">
                <div class="p-4 card mb-4">
                  ...
                  <div class="d-flex align-items-start align-items-sm-center gap-4">
                    <img class="avatar-container" src="assets/profile.png" id="profileDisplay">
                    
                    <div class="button-wrapper">
                      <label class="main-button mb-3" style="overflow: hidden; position: relative;">
                        <input type="file" name="profile_pic" id="profile_pic" onChange="displayImage(this)" accept="image/png, image/jpeg" style="opacity: 0; position: absolute; left: 0" required>Upload New Photo
                      </label>
                    </div>
                  </div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                      ...
                      <input type="text" maxlength="10" placeholder="+63" class="form-control" name="phoneNum" required>
                    </div>
                    <div class="col-md-6 mb-3">
                ...
                <div class="p-4 card">
                  ...
                  <div class="d-grid gap-2 d-md-block mt-4">
                    <button class="main-button" type="submit" name="submit">Save</button>
                  </div>
                </div>
              </form>
              <!-- / form -->
