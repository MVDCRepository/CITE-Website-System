                ...
                <div class="col-sm-12">
                    <div class="menu-area">
                            ...
                            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                                <ul class="navbar-nav md-auto">
                                    <li class="nav-item active">
                                        <a style="font-weight: 800;" class="nav-link" href="#">HOME<span class="sr-only">(current)</span></a> </li>
                                        <li class="nav-item">
                                            <a class="nav-link" href="pages/news_and_events.php">NEWS & EVENTS</a></li>
                                            <li class="nav-item">
                                                <a class="nav-link" href="pages/about.php">ABOUT</a></li>
                                                <li class="nav-item">
                                                    <a class="nav-link" href="pages/faculty.php">FACULTY</a></li>
                                                    <li class="nav-item">
                                                    ...
                                                    <li class="nav-item">
                                                        ...
                                                        <div class="dropdown-menu" aria-labelledby="navbarDropdown" style="right: auto; left: auto;">
                                                            <a class="dropdown-item" href="#">Request for Evaluation</a>
                                                            <div class="dropdown-divider"></div>
                        ...
                        <div class="services_main">
                            <div class="container">
                                ...
                                <div class="container">
                                                ...
                                                <div class="blog-slider__wrp">
                                                    <div class="blog-slider__item">
                                                        ...
                                                        <div class="blog-slider__content">
                                                            ...
                                                            <a href="pages/announcement_details.php?bulletin_id=<?=$row['bulletin_id'];?>" class="blog-slider__button mb-3">Read More</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <center><a href="" class="blog-slider__button mb-5">View All Announcements</a></center>
                                </div>
                        ...
                        <div class="service_main">
                                            ...
                                            <div class="blog-slider__wrp">
                                                <div class="blog-slider__item">
                                                    ...
                                                    <div class="blog-slider__content">
                                                        ...
                                                        <div class="blog-slider__title"><?php echo $row['title'];?></div>
                                                        <div class="blog-slider__text"><?php echo $row['content'];?></div>
                                                        <a href="pages/news_and_events_details.php?bulletin_id=<?=$row['bulletin_id'];?>" class="blog-slider__button mb-3">Read More</a>
                                                    </div>
                                                </div>
                                            </div>
                                            <?php
                            ...
                            <center><a href="pages/news_and_events.php" class="blog-slider__button mb-3">View All News & Events</a></center>
                        </div>
                        <!--End Events Section --------------------------------->
